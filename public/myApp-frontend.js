...
const displayZmaneiShabat = async () => {
  let ZmaneiShabat = await fetch('/api/zmanim/zman-shabat')
...
const displayZmaneiAyom = async () => {
  ...
  Sunrise.innerHTML = modifierHeure(ZmaneiAyom.SeaLevelSunrise)
  ...
  let TzaisRabenouTam = document.querySelector('#TzaisRabenouTam')
  TzaisRabenouTam.innerHTML = modifierHeure(ZmaneiShabat.Tzais16Point1Degrees)
...
function arrayPush(arrayImageRecup, numberOfImage) {
  arrayImageRecup.push(`/images/imageAffiche${numberOfImage}.jpg`)
  return
}
